...
export const StyledCalendar = styled('div')<{ eventColor?: string }>(({ theme, eventColor }) => ({
  width: 'calc(100% + 2px)',
  marginLeft: -1,
  marginBottom: -1,
  ...
  '& .fc .fc-event .fc-event-main': {
    padding: '2px 4px',
    borderRadius: 6,
    backgroundColor: eventColor ?? theme.palette.common.white,
    '&:before': {
      top: 0,
      left: 0,
      width: '100%',
  ...
  '& .fc .fc-timegrid-event-harness:has(.sub-shift)': {
    left: '15% !important',
    width: '80% !important',
  },
}));
