...
// ----------------------------------------------------------------------
// Shared checklist (pass/fail review + penalty flow) reused by:
//   - cleaning-review-view.tsx (standalone "Đánh giá" page)
//   - cleaning-review-dialog.tsx (popup opened from "Theo dõi tuần")
// Keep pass/fail/penalty logic here only — do not fork a second copy.
...
type Props = {
  date: string;
  block: string;
  /** Called after any successful review/penalty action, e.g. to refresh a parent overview. */
  onChanged?: () => void;
};

export default function CleaningReviewChecklist({ date, block, onChanged }: Props) {
