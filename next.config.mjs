...
const BACKEND_API_PREFIXES = [
  ...
  'shifts', 'shift-templates', 'shift-schedules', 'shift-assignments', 'shift-swap', 'shift-registrations', 'shift-cash', 'late-cover', 'shift-pool', 'shift-audit',
  ...
  'chatbot', 'messenger', 'expenses', 'shareholders', 'cleaning',
];
